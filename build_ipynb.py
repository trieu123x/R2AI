...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "        r'^(Lu\\\\u1eadt|B\\\\ed9 lu\\\\u1eadt|Ngh\\\\ecb \\\\u0111\\\\u1ecbnh|Th\\\\u00f4ng t\\\\u01b0 li\\\\u00ean t\\\\u1ecbch|Th\\\\u00f4ng t\\\\u01b0|'\n",
            "        r'Quy\\\\u1ebft \\\\u0111\\\\u1ecbnh|Ngh\\\\ecb quy\\\\u1ebft|Ph\\\\u00e1p l\\\\u1ec7nh|'\n",
            "        r'Hi\\\\u1ebfn ph\\\\u00e1p|V\\\\u0103n b\\\\u1ea3n h\\\\u1ee3p nh\\\\u1ea5t|'\n",
            ...
            "        return True\n",
            "    if is_doc_name_mentioned(r.legal_type, r.doc_number, r.title, answer):\n",
            "        return True\n",
            ...
            "    print(f\"[Citation Filter Stats] Fallback Top-1 triggered: Docs={FALLBACK_DOCS_COUNT}, Articles={FALLBACK_ARTICLES_COUNT}\")\n"
        ]
    },
    {
        "cell_type": "markdown",
